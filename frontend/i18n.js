(function () {
  const translations = {
    zh: {
      ...
      'upload.supported': '支持 .pptx, .docx, .xlsx, .pdf',
      'settings.heading': '设置',
      'form.source': '源语言',
      'form.target': '目标语言',
      'form.font': '字体（可选）',
      ...
      'form.pdfOutputLabel': 'PDF 输出格式',
      'form.pdfOutputPdf': '输出为 PDF',
      'form.pdfOutputPdfCopy': '保留 PDF 交付格式，生成翻译后的 PDF。',
      'form.pdfOutputDocx': '输出为可编辑 DOCX',
      'form.pdfOutputDocxCopy': '把 PDF 中提取的文本整理到可编辑的 Word 文档中。',
    ...
    en: {
      ...
      'upload.supported': 'Supports .pptx, .docx, .xlsx, .pdf',
      ...
      'form.pdfOutputLabel': 'PDF Output Format',
      'form.pdfOutputPdf': 'Output as PDF',
      'form.pdfOutputPdfCopy': 'Keep PDF delivery format and generate a translated PDF.',
      'form.pdfOutputDocx': 'Output as editable DOCX',
      'form.pdfOutputDocxCopy': 'Extract the PDF text into an editable Word document.',
